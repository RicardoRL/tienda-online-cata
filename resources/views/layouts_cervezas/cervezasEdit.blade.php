                ...
                <div class="form-group row">
                  ...
                  <!--- Nombre Cerveza-->
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{$cerveza->estilo}}" name="estilo" required>
                        @error('estilo')
                                    <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" pvalue="{{$cerveza->aspecto}}" name="aspecto" required>
                        @error('aspecto')
                                    <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                      </div>
