      ...
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Actualizar Cerveceria  </li>
          </ul>
        </div>
      </div>
      <section class="forms">
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display">Datos de la Cerveceria  </h1>
          </header>
                  ...
                  <!--- Nombre Cerveceria-->
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="sitio_web" placeholder="Ejemplo: www.facebook.com" value="{{$cerveceria->sitio_web}}" required>
                        @error('sitio_web')
                                    <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                      </div>
                     ...
                     <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="contacto" placeholder="3312345678" value="{{$cerveceria->contacto}}" required>
                        @error('contacto')
                                    <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                      </div>
            ...
            <div class="col-lg-8">
              <div class="card">
                ...
                <div class="col-sm-10">
                        ...
                        <input type="file" name="imagen" style="text-align:right" value="{{$cerveceria->imagen}}"> 
                    </div>
                    </div>
                </div>
              </div>
